    ...
    <li className={`min-h-[14rem] list-none ${area}`}>
      <div className="relative h-full rounded-2xl border border-border p-2">
        <GlowingEffect
          ...
          inactiveZone={0.01}
        />
        <div className="relative flex h-full flex-col justify-between gap-6 overflow-hidden rounded-xl border border-border bg-background p-6 shadow-soft">
          <div className="relative flex flex-1 flex-col justify-between gap-3">
            <div className="w-fit rounded-lg border border-border p-2">
              {icon}
            </div>
            <div className="space-y-2">
              <h3 className="pt-0.5 text-xl/[1.375rem] font-semibold font-sans -tracking-4 text-balance text-foreground">
                {title}
              </h3>
              <h3 className="text-sm/[1.125rem] font-sans text-muted-foreground [&_b]:font-semibold [&_b]:text-foreground">
                {description}
              </h3>
            </div>
          </div>
