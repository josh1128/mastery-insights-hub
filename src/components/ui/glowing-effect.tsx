            ...
            "--gradient":
              variant === "white"
                ...
                : `repeating-conic-gradient(
                    from calc(var(--start) * 1deg),
                    hsl(var(--primary)) 0%,
                    hsl(var(--primary-glow)) calc(100% / var(--repeating-conic-gradient-times)),
                    hsl(var(--accent)) calc(200% / var(--repeating-conic-gradient-times)),
                    hsl(var(--primary-glow)) calc(300% / var(--repeating-conic-gradient-times)),
                    hsl(var(--primary)) calc(400% / var(--repeating-conic-gradient-times)),
